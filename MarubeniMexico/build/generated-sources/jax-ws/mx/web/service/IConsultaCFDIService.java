...
public interface IConsultaCFDIService {
    ...
    @RequestWrapper(localName = "Consulta", targetNamespace = "http://tempuri.org/", className = "mx.web.service.Consulta")
    @ResponseWrapper(localName = "ConsultaResponse", targetNamespace = "http://tempuri.org/", className = "mx.web.service.ConsultaResponse")
