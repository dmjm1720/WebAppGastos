...
/*     */ import mx.dao.ConceptoAutobusDao;
...
/*     */ 
/*     */ 
/*     */ public class ConceptoAutobusDaoImpl
/*     */   implements ConceptoAutobusDao
/*     */ {
...
/*  30 */     String hql = "FROM Concepto WHERE nombreUsuario='" + us.getCodigoSap() + "'  AND nombreConcepto='Autobus' AND tipo='Nacional'  AND estado='Agregar' ORDER BY idConcepto DESC";
/*     */     try {
...
/* 139 */     String hql = "FROM Concepto WHERE nombreUsuario='" + us.getCodigoSap() + "'  AND nombreConcepto='Autobus' AND tipo='Extranjero' AND estado='Agregar' ORDER BY idConcepto DESC";
/*     */     try {
...
/* Location:              C:\Users\Mario Arias\Desktop\Ultima version marubeni trabajable\WebAppGastos.war!\WEB-INF\classes\mx\impl\ConceptoAutobusDaoImpl.class
