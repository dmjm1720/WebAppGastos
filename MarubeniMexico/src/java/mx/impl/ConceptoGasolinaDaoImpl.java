...
/*     */ 
/*     */ 
/*     */ public class ConceptoGasolinaDaoImpl
/*     */   implements ConceptoGasolinaDao
/*     */ {
...
/*  30 */     String hql = "FROM Concepto WHERE nombreUsuario='" + us.getCodigoSap() + "'  AND nombreConcepto='Gasolina' AND tipo='Nacional' AND estado='Agregar' ORDER BY idConcepto DESC";
/*     */     try {
...
/* 140 */     String hql = "FROM Concepto WHERE nombreUsuario='" + us.getCodigoSap() + "'  AND nombreConcepto='Gasolina' AND tipo='Extranjero' AND estado='Agregar' ORDER BY idConcepto DESC";
/*     */     try {
...
/* Location:              C:\Users\Mario Arias\Desktop\Ultima version marubeni trabajable\WebAppGastos.war!\WEB-INF\classes\mx\impl\ConceptoGasolinaDaoImpl.class
