...
/*     */ import mx.dao.ConceptoMensajeriaDao;
...
/*     */ 
/*     */ 
/*     */ public class ConceptoMensajeriaDaoImpl
/*     */   implements ConceptoMensajeriaDao
/*     */ {
...
/*  30 */     String hql = "FROM Concepto WHERE nombreUsuario='" + us.getCodigoSap() + "'  AND nombreConcepto='Mensajería' AND tipo='Nacional' AND estado='Agregar' ORDER BY idConcepto DESC";
/*     */     try {
...
/* 139 */     String hql = "FROM Concepto WHERE nombreUsuario='" + us.getCodigoSap() + "'  AND nombreConcepto='Mensajería' AND tipo='Extranjero' AND estado='Agregar' ORDER BY idConcepto DESC";
/*     */     try {
...
/* Location:              C:\Users\Mario Arias\Desktop\Ultima version marubeni trabajable\WebAppGastos.war!\WEB-INF\classes\mx\impl\ConceptoMensajeriaDaoImpl.class
