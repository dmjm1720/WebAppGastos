...
/*     */ 
/*     */ 
/*     */ public class ConceptoTaxiDaoImpl
/*     */   implements ConceptoTaxiDao
/*     */ {
...
/*  30 */     String hql = "FROM Concepto WHERE nombreUsuario='" + us.getCodigoSap() + "'  AND nombreConcepto='Taxi' AND tipo='Nacional'  AND estado='Agregar' ORDER BY idConcepto DESC";
/*     */     try {
...
/*     */     } catch (Exception e) {
/*  51 */       FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "SISTEMA DE GASTOS", "Factura o UUID duplicado"));
...
/* 140 */     String hql = "FROM Concepto WHERE nombreUsuario='" + us.getCodigoSap() + "'  AND nombreConcepto='Taxi' AND tipo='Extranjero' AND estado='Agregar' ORDER BY idConcepto DESC";
/*     */     try {
...
/* Location:              C:\Users\Mario Arias\Desktop\Ultima version marubeni trabajable\WebAppGastos.war!\WEB-INF\classes\mx\impl\ConceptoTaxiDaoImpl.class
