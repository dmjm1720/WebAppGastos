...
import mx.impl.ConceptoHotelDaoImpl;
...
@Named("conceptoHotelBean")
@ViewScoped
public class conceptoHotelBean extends DAO implements Serializable {
    ...
    public List<Concepto> getListaConceptoUSD() {
        ConceptoHotelDao cDao = new ConceptoHotelDaoImpl();
    ...
    public List<SelectItem> getListNombreUsuario() {
        ...
        ConceptoHotelDao uDao = new ConceptoHotelDaoImpl();
