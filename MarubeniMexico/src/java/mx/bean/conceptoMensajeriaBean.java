...
import mx.impl.ConceptoMensajeriaDaoImpl;
...
@Named("conceptoMensajeriaBean")
@ViewScoped
public class conceptoMensajeriaBean extends DAO implements Serializable {
    ...
    public List<Concepto> getListaConceptoUSD() {
        ConceptoMensajeriaDao cDao = new ConceptoMensajeriaDaoImpl();
    ...
    public List<SelectItem> getListNombreUsuario() {
        ...
        ConceptoMensajeriaDao uDao = new ConceptoMensajeriaDaoImpl();
