 ...
 import mx.impl.ConceptoTaxiDaoImpl;
 ...
 @Named("conceptoTaxiBean")
 @ViewScoped
 public class conceptoTaxiBean extends DAO implements Serializable
 {
   ...
   {
     ConceptoTaxiDao cDao = new ConceptoTaxiDaoImpl();
   ...
   public List<SelectItem> getListNombreUsuario() {
     ...
     ConceptoTaxiDao uDao = new ConceptoTaxiDaoImpl();
