...
import mx.impl.ConceptoCasetaDaoImpl;
...
@Named("conceptoCasetaBean")
@ViewScoped
public class conceptoCasetaBean extends DAO implements Serializable {
    ...
    public List<Concepto> getListaConceptoUSD() {
        ConceptoCasetaDao cDao = new ConceptoCasetaDaoImpl();
    ...
    public List<SelectItem> getListNombreUsuario() {
        ...
        ConceptoCasetaDao uDao = new ConceptoCasetaDaoImpl();
