...
import mx.impl.ConceptoAsignacionDaoImpl;
...
@Named("conceptoAsignacionBean")
@ViewScoped
public class conceptoAsignacionBean extends DAO implements Serializable {
    ...
    public List<Concepto> getListaConceptoUSD() {
        ConceptoAsignacionDao cDao = new ConceptoAsignacionDaoImpl();
    ...
    public void nuevoConcepto() {
        ...
        if (this.concepto.getTipo().equals("Nacional")) {
            ...
            RequestContext.getCurrentInstance().execute("PF('dialogNuevoConTCoorp').hide();PF('dlgDolaresSTC').hide();PF('dlgNewDolares').hide();PF('dlgSubirImagen').show();");
        }
    }
    ...
    public List<SelectItem> getListNombreUsuario() {
        ...
        ConceptoAsignacionDao uDao = new ConceptoAsignacionDaoImpl();
