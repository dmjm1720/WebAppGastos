...
@javax.inject.Named("PdfUpdateBean")
@javax.faces.view.ViewScoped
public class PdfUpdateBean extends mx.conexion.DAO implements java.io.Serializable {
    ...
    public void copyFile(String fileName, InputStream in) throws SQLException {
        try {
            ...
            File directorio = new File(getRuta());
            ...
            setRutaPDF("/resources/upload/" + fileName);
            actualizarPDF();
            Cerrar();
            FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "SISTEMA DE GASTOS", "PDF actualizado correctamente"));
            in.close();
            dir.flush();
            dir.close();
        } catch (IOException e) {
