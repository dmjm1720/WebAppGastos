...
import mx.impl.ConceptoOtroDaoImpl;
...
@Named("conceptoOtroBean")
@ViewScoped
public class conceptoOtroBean
        extends DAO
    ...
    public List<Concepto> getListaConceptoUSD() {
        ConceptoOtroDao cDao = new ConceptoOtroDaoImpl();
    ...
    public List<SelectItem> getListNombreUsuario() {
        ...
        ConceptoOtroDao uDao = new ConceptoOtroDaoImpl();
