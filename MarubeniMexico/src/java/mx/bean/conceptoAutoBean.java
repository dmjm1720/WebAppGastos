...
import mx.impl.ConceptoAutoDaoImpl;
...
@Named("conceptoAutoBean")
@ViewScoped
public class conceptoAutoBean extends DAO implements Serializable {
    ...
    public List<Concepto> getListaConceptoUSD() {
        ConceptoAutoDao cDao = new ConceptoAutoDaoImpl();
    ...
    public List<SelectItem> getListNombreUsuario() {
        ...
        ConceptoAutoDao uDao = new ConceptoAutoDaoImpl();
