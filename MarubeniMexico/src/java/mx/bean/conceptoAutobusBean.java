...
import mx.impl.ConceptoAutobusDaoImpl;
...
@Named("conceptoAutobusBean")
@ViewScoped
public class conceptoAutobusBean extends DAO implements Serializable {
    ...
    public List<Concepto> getListaConceptoUSD() {
        ConceptoAutobusDao cDao = new ConceptoAutobusDaoImpl();
    ...
    public List<SelectItem> getListNombreUsuario() {
        ...
        ConceptoAutobusDao uDao = new ConceptoAutobusDaoImpl();
